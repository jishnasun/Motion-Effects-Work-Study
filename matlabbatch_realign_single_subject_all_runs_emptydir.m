...
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_cd.dir = {'/home/jovyan/data/derivatives'};  % Change this directory to the directory that holds all the subject files
...
matlabbatch{4}.cfg_basicio.file_dir.file_ops.cfg_file_split.index = {
                                                                     ...
                                                                     6
                                                                     7
                                                                     }'; % Change number in index and below depending on the number of runs in each subject file (in this case there are 7 runs per participant)
...
matlabbatch{5}.spm.spatial.realign.estimate.eoptions.quality = 0.9; % can also change quality to increase speed, but values will be less accurate
matlabbatch{5}.spm.spatial.realign.estimate.eoptions.sep = 4;
matlabbatch{5}.spm.spatial.realign.estimate.eoptions.fwhm = 5;
matlabbatch{5}.spm.spatial.realign.estimate.eoptions.rtm = 0; % Aligns to first rather than the mean, for the sake of speed (change to 1 to align to mean)
